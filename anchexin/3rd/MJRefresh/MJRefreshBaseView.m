...
//#ifdef NeedAudio
    // 7.加载音频
    _pullId = [self loadId:@"end_refreshing.wav"];
    _normalId = [self loadId:@"end_refreshing.wav"];
    _refreshingId = [self loadId:@"end_refreshing.wav"];
...
- (void)setFrame:(CGRect)frame
{
    ...
    _statusLabel.frame = CGRectMake(statusX, statusY+18, statusWidth, statusHeight);
    
    // 2.时间标签
    CGFloat lastUpdateY = statusY + statusHeight + 15;
